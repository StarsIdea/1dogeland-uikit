...
var BottomNavItem = function (_a) {
    ...
    return showItemsOnMobile ? (React.createElement(StyledBottomNavItem, __assign({ type: "button" }, props), bottomNavItemContent)) : (React.createElement(StyledBottomNavItem, __assign({ as: Link$1, to: href }, props), bottomNavItemContent));
};
...
var DropdownMenu = function (_a) {
    ...
    return (React.createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        ...
        isBottomNav && isOpen && showItemsOnMobile && React.createElement(StyledOverlay, null),
