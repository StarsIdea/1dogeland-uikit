import React, { createElement, Children, isValidElement, cloneElement, useRef, useEffect, useState, useMemo, useReducer, useCallback, createContext, useContext } from 'react';
import styled, { keyframes, css, useTheme, createGlobalStyle } from 'styled-components';
import { space, flexbox, layout, background, border, position, grid } from 'styled-system';
...
var Icon$1m = function (props) {
    return (createElement(Svg, __assign({ viewBox: "0 0 20 20", xmlns: "http://www.w3.org/2000/svg" }, props),
        createElement("path", { d: "M12.09 13.412c-.448.447-1.408.607-2.09.607-.682 0-1.642-.16-2.09-.607a.27.27 0 00-.383 0 .27.27 0 000 .383c.714.704 2.068.757 2.473.757.405 0 1.76-.053 2.473-.767a.27.27 0 000-.384.28.28 0 00-.383.01zM8.753 11.034c0-.576-.47-1.045-1.045-1.045-.576 0-1.045.47-1.045 1.045 0 .576.47 1.045 1.045 1.045.576 0 1.045-.47 1.045-1.045z" }),
        createElement("path", { d: "M10 0C4.478 0 0 4.478 0 10s4.478 10 10 10 10-4.467 10-10c-.01-5.522-4.478-10-10-10zm5.8 11.333c.02.138.032.287.032.437 0 2.25-2.612 4.062-5.832 4.062-3.22 0-5.832-1.813-5.832-4.062 0-.15.011-.299.032-.437A1.447 1.447 0 013.337 10 1.463 1.463 0 015.81 8.945c1.013-.736 2.41-1.194 3.966-1.237 0-.021.736-3.486.736-3.486 0-.064.042-.128.096-.16a.263.263 0 01.202-.043l2.42.523c.17-.342.523-.587.928-.587A1.04 1.04 0 0115.203 5a1.04 1.04 0 01-1.045 1.045 1.034 1.034 0 01-1.034-.992l-2.175-.469-.661 3.124c1.535.053 2.91.522 3.902 1.237a1.454 1.454 0 012.473 1.044 1.48 1.48 0 01-.863 1.344z" }),
        createElement("path", { d: "M12.292 10c-.576 0-1.045.47-1.045 1.045s.47 1.045 1.045 1.045c.576 0 1.045-.47 1.045-1.045A1.06 1.06 0 0012.292 10z" })));
};
...
var Icon$1o = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1s = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1y = function (props) {
    return (createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        createElement("path", { d: "M1.87 6.163a.75.75 0 01-1.06-1.06l2.608-2.61H1.694a.75.75 0 110-1.5h3.535a.75.75 0 01.75.75V5.28a.75.75 0 11-1.5 0V3.554L1.87 6.164zM13.072 1.976a5 5 0 01.421 9.983A6.505 6.505 0 008.09 6.555a5 5 0 014.982-4.579z" }),
        createElement("path", { d: "M12.072 12.976a5 5 0 10-10 0 5 5 0 0010 0zM19.26 14.213a.75.75 0 010 1.061l-2.61 2.609h1.726a.75.75 0 010 1.5H14.84a.75.75 0 01-.75-.75v-3.536a.75.75 0 011.5 0v1.725l2.609-2.609a.75.75 0 011.06 0z" })));
};
...
var Icon$1J = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1K = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$25 = function (props) {
    return (createElement(Svg, __assign({ viewBox: "0 0 19 20" }, props),
        createElement("path", { d: "M9.853.8a1 1 0 00-1.706 0L4.43 6.882a1 1 0 00.853 1.522h7.434a1 1 0 00.853-1.522L9.853.8zm4.647 9.604c-2.49 0-4.5 2.01-4.5 4.5s2.01 4.5 4.5 4.5 4.5-2.01 4.5-4.5-2.01-4.5-4.5-4.5zM0 16.904a2 2 0 002 2h4a2 2 0 002-2v-4a2 2 0 00-2-2H2a2 2 0 00-2 2v4z" })));
};
...
var Icon$29 = function (props) {
    return (createElement(Svg, __assign({ viewBox: "0 0 22 20" }, props),
        createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M12.207 17.836a1 1 0 011-1v-2a1 1 0 01-1-1v-2a1 1 0 011-1h2.404l-1.904-3.728a6 6 0 00-3.234-2.889l1.05-2.801a.75.75 0 00-.825-1.004l-5.24.874a.75.75 0 00-.547 1.075l.945 1.889a6 6 0 00-3.15 2.856l-2.042 4c-2.038 3.992.861 8.728 5.344 8.728h4.398c.635 0 1.239-.095 1.801-.27v-1.73zM8.171 7.086a.75.75 0 01.75.75v.302a2.25 2.25 0 011.476 1.082l.14.244a.75.75 0 11-1.303.745l-.14-.245a.75.75 0 00-.65-.378h-.487a.75.75 0 100 1.5h.687a2.25 2.25 0 01.277 4.484v.266a.75.75 0 01-1.5 0v-.3a2.25 2.25 0 01-1.476-1.083l-.14-.244a.75.75 0 011.303-.745l.14.245a.75.75 0 00.65.377h.746a.75.75 0 100-1.5h-.687a2.25 2.25 0 01-.536-4.435v-.315a.75.75 0 01.75-.75z" }),
        createElement("path", { d: "M14.707 14.836a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-1a.5.5 0 00-.5-.5h-6zM13.707 11.836a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-1a.5.5 0 00-.5-.5h-6zM13.707 17.836a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-1a.5.5 0 00-.5-.5h-6z" })));
};

var Icon$2a = function (props) { return (createElement(Svg, __assign({ viewBox: "0 0 19 17" }, props),
    createElement("path", { d: "M16.5 2h-2a2 2 0 00-2-2h-6a2 2 0 00-2 2h-2c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94A5.01 5.01 0 008.5 12.9V15h-3a1 1 0 100 2h8a1 1 0 100-2h-3v-2.1a5.01 5.01 0 003.61-2.96C16.58 9.63 18.5 7.55 18.5 5V4c0-1.1-.9-2-2-2zm-14 3V4h2v3.82C3.34 7.4 2.5 6.3 2.5 5zm7 6c-1.65 0-3-1.35-3-3V2h6v6c0 1.65-1.35 3-3 3zm7-6c0 1.3-.84 2.4-2 2.82V4h2v1z" }))); };

var Icon$2b = function (props) { return (createElement(Svg, __assign({ viewBox: "0 0 18 20" }, props),
    createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M5.95.446a1.5 1.5 0 00-1.11 1.808c.08.327.457 1.213.877 2.15H2c-1.1 0-2 .9-2 2v1c0 .319.03.63.087.931.401 2.111 2.142 3.738 4.303 4.009A5.01 5.01 0 008 15.304v2.1H5a1 1 0 100 2h8.006a1 1 0 00-.006-2h-3v-2.1a5.013 5.013 0 003.61-2.96c.309-.039.609-.105.898-.197C16.53 11.507 18 9.635 18 7.404v-1c0-1.1-.9-2-2-2h-3.718c.42-.937.798-1.823.877-2.15a1.5 1.5 0 00-2.918-.7l-.683 2.85H8.442l-.684-2.85A1.5 1.5 0 005.949.446zM16 7.404c0 1.3-.84 2.4-2 2.82v-3.82h2v1zm-12 2.82c-1.16-.42-2-1.52-2-2.82v-1h2v3.82z" }))); };
...
var Icon$2c = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 225 225" }, props),
        React.createElement("g", { transform: "translate(0.000000,225.000000) scale(0.100000,-0.100000)" },
            React.createElement("path", { d: "M14 2225 c3 -8 51 -115 106 -237 l102 -223 339 -320 c186 -175 339\r\n        -322 339 -327 0 -8 -369 -401 -381 -406 -5 -2 -58 27 -119 64 l-111 67 -30\r\n        -29 c-16 -15 -29 -31 -29 -34 0 -4 45 -51 100 -106 55 -54 100 -104 100 -109\r\n        0 -6 -63 -81 -141 -168 -122 -136 -144 -157 -170 -157 -62 0 -119 -57 -119\r\n        -120 0 -54 65 -120 118 -120 66 0 121 55 123 122 0 30 15 46 155 168 86 74\r\n        161 136 167 138 7 1 57 -43 111 -98 54 -55 102 -100 106 -100 3 0 19 13 34 29\r\n        l28 29 -67 111 c-36 61 -65 115 -63 120 2 4 95 94 207 200 201 189 204 191\r\n        225 174 11 -10 95 -88 186 -174 91 -86 175 -164 188 -175 12 -10 22 -23 22\r\n        -28 0 -6 -30 -59 -66 -119 l-66 -108 28 -30 c15 -16 31 -29 34 -29 4 0 51 45\r\n        105 100 55 55 104 100 110 100 5 0 46 -32 90 -72 233 -207 235 -209 235 -239\r\n        0 -63 57 -119 122 -119 53 0 118 66 118 120 0 61 -58 120 -118 120 -25 0 -43\r\n        15 -109 87 -134 147 -203 228 -203 238 0 5 46 56 102 112 l103 103 -32 31 -31\r\n        32 -111 -67 c-61 -37 -115 -66 -120 -64 -12 5 -381 398 -381 406 0 4 127 127\r\n        283 273 155 146 308 290 339 320 54 51 64 68 164 287 58 129 103 236 101 238\r\n        -2 3 -110 -43 -238 -101 l-234 -106 -320 -340 -320 -339 -41 43 c-22 23 -151\r\n        159 -285 302 -134 143 -260 277 -279 297 -27 29 -87 61 -267 143 -127 58 -235\r\n        105 -238 105 -4 0 -5 -7 -1 -15z" }))));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AccountIcon: Icon$4,
    AccountFilledIcon: Icon$5,
    AddIcon: Icon$6,
    ArrowBackIcon: Icon$7,
    ArrowDownIcon: Icon$8,
    ArrowDropDownIcon: Icon$9,
    ArrowDropUpIcon: Icon$a,
    ArrowFirstIcon: Icon$b,
    ArrowForwardIcon: Icon$c,
    ArrowLastIcon: Icon$d,
    ArrowUpIcon: Icon$e,
    AutoRenewIcon: Icon$f,
    BinanceIcon: Icon$g,
    BinanceChainIcon: Icon$h,
    BlockIcon: Icon$2,
    BnbUsdtPairTokenIcon: Icon$i,
    BscScanIcon: Icon$j,
    BunnyCardsIcon: Icon$k,
    BunnyPlaceholderIcon: Icon$l,
    CameraIcon: Icon$m,
    Cards: Icon$n,
    CardViewIcon: Icon$o,
    CalculateIcon: Icon$p,
    CircleOutlineIcon: Icon$q,
    ChartIcon: Icon$r,
    CheckmarkIcon: Icon$s,
    CheckmarkCircleIcon: Icon,
    CheckmarkCircleFillIcon: Icon$t,
    ChevronDownIcon: Icon$u,
    ChevronLeftIcon: Icon$v,
    ChevronRightIcon: Icon$w,
    ChevronUpIcon: Icon$x,
    CloseIcon: Icon$y,
    CogIcon: Icon$z,
    Coin98Icon: Icon$A,
    CommunityIcon: Icon$B,
    CommunityFilledIcon: Icon$C,
    CopyIcon: Icon$D,
    CrownIcon: Icon$E,
    CurrencyIcon: Icon$F,
    EarnIcon: Icon$G,
    EarnFilledIcon: Icon$H,
    ErrorIcon: Icon$1,
    EllipsisIcon: Icon$I,
    InstagramIcon: Icon$J,
    GithubIcon: Icon$K,
    HelpIcon: Icon$L,
    HistoryIcon: Icon$M,
    InfoIcon: Icon$3,
    LanguageIcon: Icon$N,
    LanguageCurrencyIcon: Icon$O,
    LaurelLeftIcon: Icon$P,
    LaurelRightIcon: Icon$Q,
    ListViewIcon: Icon$R,
    LoginIcon: Icon$S,
    LogoIcon: Icon$T,
    LogoWithTextIcon: LogoWithText,
    LogoRoundIcon: Icon$U,
    MathWalletIcon: Icon$V,
    LogoutIcon: Icon$W,
    MedalBronzeIcon: Icon$X,
    MedalGoldIcon: Icon$Y,
    MedalPurpleIcon: Icon$Z,
    MedalSilverIcon: Icon$_,
    MedalTealIcon: Icon$$,
    MetamaskIcon: Icon$10,
    MinusIcon: Icon$11,
    MoreHorizontalIcon: Icon$12,
    MoreVerticalIcon: Icon$13,
    NftIcon: Icon$14,
    NftFilledIcon: Icon$15,
    NoProfileAvatarIcon: Icon$16,
    OpenNewIcon: Icon$17,
    PancakesIcon: Icon$18,
    PencilIcon: Icon$19,
    PancakeRoundIcon: Icon$1a,
    PocketWatchIcon: Icon$1b,
    PlayCircleOutlineIcon: Icon$1c,
    PredictionsIcon: Icon$1d,
    PrizeIcon: Icon$1e,
    ProposalIcon: Icon$1f,
    RemoveIcon: Icon$1g,
    VerifiedIcon: Icon$1h,
    ProgressBunny: Icon$1i,
    PresentCheckIcon: Icon$1j,
    PresentWonIcon: Icon$1k,
    PresentNoneIcon: Icon$1l,
    RedditIcon: Icon$1m,
    RefreshIcon: Icon$1n,
    ResourcesIcon: Icon$1o,
    ResourcesFilledIcon: Icon$1p,
    SafePalIcon: Icon$1q,
    SearchIcon: Icon$1r,
    SellIcon: Icon$1s,
    ShareIcon: Icon$1t,
    SmallDotIcon: Icon$1u,
    StarFillIcon: Icon$1v,
    StarLineIcon: Icon$1w,
    SwapIcon: Icon$1x,
    SwapFillIcon: Icon$1y,
    SwapVertIcon: Icon$1z,
    SyncAltIcon: Icon$1A,
    TeamPlayerIcon: Icon$1B,
    TelegramIcon: Icon$1C,
    TestnetIcon: Icon$1D,
    Ticket: Icon$1E,
    TicketFillIcon: Icon$1F,
    TicketRound: Icon$1G,
    TimerIcon: Icon$1H,
    TokenPocketIcon: Icon$1I,
    TradeIcon: Icon$1J,
    TradeFilledIcon: Icon$1K,
    TrophyGoldIcon: Icon$1L,
    TrustWalletIcon: Icon$1M,
    TwitterIcon: Icon$1N,
    TuneIcon: Icon$1O,
    VisibilityOff: Icon$1P,
    VisibilityOn: Icon$1Q,
    VolumeOffIcon: Icon$1R,
    VolumeUpIcon: Icon$1S,
    VoteIcon: Icon$1T,
    WarningIcon: Icon$1U,
    WalletConnectIcon: Icon$1V,
    WalletIcon: Icon$1W,
    WalletFilledIcon: Icon$1X,
    WaitIcon: Icon$1Y,
    FarmIcon: Icon$1Z,
    GroupsIcon: Icon$1_,
    HamburgerIcon: Icon$1$,
    HamburgerCloseIcon: Icon$20,
    HomeIcon: Icon$21,
    IfoIcon: Icon$22,
    MoonIcon: Icon$23,
    MoreIcon: Icon$24,
    ...
    PoolIcon: Icon$26,
    SunIcon: Icon$27,
    TeamBattleIcon: Icon$28,
    TicketIcon: Icon$1E,
    EarnFillIcon: Icon$29,
    TrophyIcon: Icon$2a,
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$17, { color: "primary", ml: "4px" })));
};
        ...
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$7, { color: "primary" }))),
...
var Flex$1 = styled(Box)(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  display: flex;\n  ", "\n"], ["\n  display: flex;\n  ", "\n"])), flexbox);
var templateObject_1$y;

styled(Box)(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  display: grid;\n  ", "\n  ", "\n"], ["\n  display: grid;\n  ", "\n  ", "\n"])), flexbox, grid);
...
var DropdownMenuItem = styled.button(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"], ["\n  align-items: center;\n  border: 0;\n  background: transparent;\n  color: ", ";\n  cursor: ", ";\n  font-weight: ", ";\n  display: flex;\n  font-size: 16px;\n  height: 48px;\n  justify-content: space-between;\n  outline: 0;\n  padding-left: 16px;\n  padding-right: 16px;\n  width: 100%;\n\n  &:hover:not(:disabled) {\n    background-color: ", ";\n  }\n\n  &:active:not(:disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n  }\n"])), function (_a) {
...
var StyledDropdownMenuItemContainer = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  &:first-child > ", " {\n    border-top-left-radius: 8px;\n    border-top-right-radius: 8px;\n  }\n\n  &:last-child > ", " {\n    border-bottom-left-radius: 8px;\n    border-bottom-right-radius: 8px;\n  }\n"], ["\n  &:first-child > ", " {\n    border-top-left-radius: 8px;\n    border-top-right-radius: 8px;\n  }\n\n  &:last-child > ", " {\n    border-bottom-left-radius: 8px;\n    border-bottom-right-radius: 8px;\n  }\n"])), DropdownMenuItem, DropdownMenuItem);
...
var DropdownMenu = function (_a) {
    ...
    return (React.createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        React.createElement(Box, { ref: isBottomNav ? setTargetRef : null }, children),
        isBottomNav && isOpen && showItemsOnMobile && hasItems && React.createElement(StyledOverlay, null),
        hasItems && (React.createElement(StyledDropdownMenu, __assign({ style: styles.popper, ref: setTooltipRef }, attributes.popper, { "$isBottomNav": isBottomNav, "$isOpen": isOpen && ((isBottomNav && showItemsOnMobile) || !isBottomNav) }), items.map(function (_a, index) {
            ...
            return (React.createElement(StyledDropdownMenuItemContainer, { key: index },
                ...
                type === DropdownMenuItemType.INTERNAL_LINK && (React.createElement(DropdownMenuItem, __assign({ "$isActive": isActive, as: Link$1, to: href }, itemProps), MenuItemContent)),
                type === DropdownMenuItemType.EXTERNAL_LINK && (React.createElement(DropdownMenuItem, __assign({ "$isActive": isActive, as: "a", href: href, target: "_blank" }, itemProps),
                    React.createElement(Flex$1, { alignItems: "center", justifyContent: "space-between", width: "100%" },
                        label,
...
var BottomNav = function (_a) {
    ...
    return (React.createElement(StyledBottomNavItem$1, __assign({ justifyContent: "space-around" }, props), items.map(function (_a) {
        var label = _a.label, _b = _a.items, menuItems = _b === void 0 ? [] : _b, href = _a.href, icon = _a.icon, _c = _a.showOnMobile, showOnMobile = _c === void 0 ? true : _c, _d = _a.showItemsOnMobile, showItemsOnMobile = _d === void 0 ? true : _d;
        return (showOnMobile && (React.createElement(DropdownMenu, { key: label, items: menuItems, isBottomNav: true, activeItem: activeSubItem, showItemsOnMobile: showItemsOnMobile },
            React.createElement(Box, null,
                React.createElement(BottomNavItem, { href: href, hasChild: menuItems.length, isActive: href === activeItem, label: label, iconName: icon, showItemsOnMobile: showItemsOnMobile })))));
    })));
};
...
var MenuItem = function (_a) {
    ...
    return (React.createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant },
        React.createElement(StyledMenuItem, __assign({ as: Link$1, to: href, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children)));
};
...
var MenuItems = function (_a) {
    ...
    return (React.createElement(Flex$1, __assign({}, props), items.map(function (_a) {
        var _b, _c;
        ...
        return (React.createElement(DropdownMenu, { key: label, items: menuItems, py: 1, activeItem: activeSubItem },
            React.createElement(MenuItem, { href: href, isActive: isActive, statusColor: statusColor }, label || React.createElement(IconComponent, { iconName: icon, color: isActive ? "secondary" : "textSubtle" }))));
    })));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        ...
        React.createElement(Text, { color: color, bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var Logo$1 = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React.createElement("image", { width: "48", height: "48", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};

var StyledLink$1 = styled(Link$1)(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 48px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 48px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Logo$2 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(LogoText, null, "1DogeLand")));
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "1Doge home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "1Doge home page" }, innerLogo))));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$D, { width: "20px", color: "primary", ml: "4px" }),
...
styled(Overlay)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark; _a.toggleTheme; _a.langs; _a.setLang; _a.currentLang; var cakePriceUsd = _a.cakePriceUsd, links = _a.links; _a.footerLinks; _a.priceLink; _a.buyCakeLabel; _a.profile; var children = _a.children;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    var _c = useState(!isMobile), isPushed = _c[0]; _c[1];
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(Flex, null,
                React.createElement(Logo$2, { isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                !isMobile && React.createElement(MenuItems, { items: links, ml: "24px" })),
            React.createElement(Flex, { alignItems: "center" },
                !isMobile && (React.createElement(Box, { mr: "12px" },
                    React.createElement(CakePrice$1, { cakePriceUsd: cakePriceUsd }))),
                React.createElement(UserBlock, { account: account, login: login, logout: logout }))),
        React.createElement(BodyWrapper, null,
            React.createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children),
            isMobile && React.createElement(BottomNav, { items: links }))));
};
var templateObject_1$J, templateObject_2$g, templateObject_3$7, templateObject_4$3, templateObject_5$2;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
